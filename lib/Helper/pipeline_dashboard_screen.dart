...
// ✅ FIXED: Replaced all AppColors.gray300 placeholders with correct colors
const Color _kTableHeaderBg    = Color(0xFFF5F3FF); // light purple tint
const Color _kTableHeaderText  = AppColors.purple800;
const Color _kTableAccentBlue  = AppColors.purple500;
const Color _kTableBodyText    = AppColors.grayDark2;
const Color _kTableMutedText   = AppColors.indigoVariant4;
...
class _FilteredLeadsScreen extends StatelessWidget {
  ...
  // ✅ FIXED: Real colors per filter
  Color get _color => switch (filter) {
        PipelineFilter.pendingQuotation => AppColors.orangeAccent2,
        PipelineFilter.dealDone        => AppColors.indigo,
        PipelineFilter.completed       => AppColors.tealDark,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: AppColors.veryLight3, // ✅ FIXED
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: _PipelineAppBar(
        ...
        color: AppColors.blueVariant, // ✅ FIXED: was gray300
      ),
      body: isLoading
          ? const Center(
              child: CircularProgressIndicator(color: AppColors.purple500))
              ...
              child: Column(
                ...
                children: [
                  _VisitSectionWidget(
                    ...
                    accentColor: AppColors.purple500, // ✅ FIXED
                  ...
                  _VisitSectionWidget(
                    ...
                    accentColor: AppColors.blueVariant, // ✅ FIXED
...
BoxDecoration _tableDecor() => BoxDecoration(
      color: Colors.white,
      borderRadius: BorderRadius.circular(16),
      border: Border.all(color: const Color(0xFFE8E3F5)), // ✅ FIXED: subtle purple border
      boxShadow: [
        BoxShadow(
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: const BoxDecoration(
        color: _kTableHeaderBg, // ✅ FIXED: light purple tint
        border: Border(
          bottom: BorderSide(color: Color(0xFFE8E3F5), width: 1),
        ),
      ),
              ...
              (c) => SizedBox(
                ...
                child: Text(
                  ...
                  style: const TextStyle(
                    fontSize: 12,
                    fontWeight: FontWeight.w600,
                    color: _kTableHeaderText, // ✅ FIXED: purple800
                  ),
                  overflow: TextOverflow.ellipsis,
                ),
              ),
...
class _TableRowWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Material(
          color: isOdd ? const Color(0xFFF9F7FF) : Colors.white, // ✅ FIXED: very light purple stripe
          child: InkWell(
            onTap: onTap,
            splashColor: AppColors.purpleLight1,
            highlightColor: AppColors.purpleLight1,
            hoverColor: AppColors.purpleLight2,
        ...
        if (!isLast)
          const Divider(
              height: 1, thickness: 1, color: Color(0xFFEDE9F6)),
      ],
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: color.withValues(alpha: 0.10),       // ✅ FIXED: uses passed accentColor
      ...
      child: Text(
        ...
        style: TextStyle(
            fontSize: 10,
            fontWeight: FontWeight.w700,
            color: color),                           // ✅ FIXED: uses passed accentColor
        overflow: TextOverflow.ellipsis,
      ),
    );
  }
...
class _PipelineAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    return AppBar(
      backgroundColor: color, // ✅ uses real color per filter
      elevation: 0,
      leading: IconButton(
  ...
  Widget build(BuildContext context) {
    return Row(children: [
      Container(
        ...
        decoration: BoxDecoration(
          color: color.withValues(alpha: 0.12), // ✅ FIXED: tinted icon bg
      ...
      Text(label,
          style: const TextStyle(
              fontSize: 16,
              fontWeight: FontWeight.w700,
              color: AppColors.grayDark2)), // ✅ FIXED
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Column(
        ...
        children: [
          AppSvgIcon(svgIcon, size: 64, color: Colors.grey.shade200),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: const Color(0xFFE8E3F5)), // ✅ FIXED
      ),
