...
class _State extends State<SolarTechnicalVisitScreen> {
  ...
  void _save() {
    ...
    String? getNullIfEmpty(TextEditingController c) {
    ...
    if (widget.isEditing) {
      cubit.editTechnicalVisit(
        id,
        systemKW: getNullIfEmpty(_systemKWC),
        inverterBoardType: getNullIfEmpty(_inverterBoardC),
        panelBoardType: getNullIfEmpty(_panelBoardC),
        panelCapacity: getNullIfEmpty(_panelCapacityC),
        cableType: getNullIfEmpty(_cableTypeC),
        acDBType: getNullIfEmpty(_acDBTypeC),
        structureHeight: getNullIfEmpty(_structureHeightC),
        beamLineDetails: getNullIfEmpty(_beamLineC),
        totalArray: getNullIfEmpty(_totalArrayC),
        scaffoldingDetails: getNullIfEmpty(_scaffoldingC),
        panelLayout: getNullIfEmpty(_panelLayoutC),
        lugType: getNullIfEmpty(_lugTypeC),
        ...
        body: ListView(padding: const EdgeInsets.all(12), children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border:
                  Border.all(color: LeadTheme.primary.withValues(alpha: 0.2)),
          ...
          _buildCard(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              _field(_inverterBoardC, 'Inverter Brand', AppSvgAssets.circleCheckBig),
              const SizedBox(height: 8),
              _field(_panelBoardC, 'Panel Brand', AppSvgAssets.circleCheckBig),
              const SizedBox(height: 8),
          ...
          _buildCard(
            ...
            children: [
              _field(_structureHeightC, 'Terrace Size', AppSvgAssets.maximize),
              const SizedBox(height: 8),
              _field(_beamLineC, 'Front Leg Height', AppSvgAssets.circleCheckBig),
              const SizedBox(height: 8),
              _field(_scaffoldingC, 'Back Leg Height', AppSvgAssets.circleCheckBig),
              const SizedBox(height: 8),
              _field(_acDBTypeC, 'Total Leg Height', AppSvgAssets.circleCheckBig),
              const SizedBox(height: 8),
              _field(_lugTypeC, 'Support Pipe', AppSvgAssets.circleCheckBig),
              const SizedBox(height: 8),
              _field(_panelLayoutC, 'Panel Layout', AppSvgAssets.circleCheckBig),
            ],
          ),
          ...
          _buildCard(
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                items: const [
                  DropdownMenuItem(value: 'single_phase', child: Text('Single Phase')),
                  DropdownMenuItem(value: 'three_phase', child: Text('Three Phase')),
                ],
          ...
          _saveBtn(
            _saving,
            _save,
            widget.isEditing ? 'Update Technical Visit' : 'Mark Technical Visit Done',
          ),
...
Widget _field(TextEditingController c, String label, String svgAsset,
    {int maxLines = 1}) =>
    LeadTextFormField(
      controller: c,
      label: label,
