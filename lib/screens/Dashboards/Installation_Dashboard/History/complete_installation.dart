...
const _kGreen  = Color.fromARGB(255, 128, 59, 240);
const _kPurple = AppColors.accent2;
...
class _CompletedInstallationsScreenState
  ...
  void _computeLists(List<InstallationModel> all) {
    ...
    final completed = all
        ...
        .toList()
      ..sort((a, b) {
        final da = a.projectCompletedAt ?? a.completedDate ?? a.assignedDate;
        final db = b.projectCompletedAt ?? b.completedDate ?? b.assignedDate;
        return db.compareTo(da);
      });

    _allCompleted       = completed;
    _solarCompleted     = completed.where((m) => m.projectType.toLowerCase() == 'solar').toList();
    _sprinklerCompleted = completed.where((m) => m.projectType.toLowerCase() != 'solar').toList();
      ...
      builder: (ctx, state) {
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: const Text('Completed Installations',
                style: TextStyle(
                    fontSize: 16,
                      ...
                      children: [
                          ...
                          child: TabBar(
                            ...
                            tabs: [
                              ...
                              Tab(child: Row(mainAxisSize: MainAxisSize.min, children: [
                                ...
                                const SizedBox(width: 4),
                                Text('Project (${_solarCompleted.length})'),
                              ])),
                              Tab(child: Row(mainAxisSize: MainAxisSize.min, children: [
                                const AppSvgIcon(AppSvgAssets.droplet, size: 14),
                                const SizedBox(width: 4),
                                Text('Sprinkler (${_sprinklerCompleted.length})'),
                              ])),
                            ],
                          ),
                        ),
                                ...
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    suffixIcon: _searchCtrl.text.isNotEmpty
                                        ? IconButton(
                                        icon: const AppSvgIcon(AppSvgAssets.x,
                                                size: 13),
                                            onPressed: () =>
                                                _searchCtrl.clear())
                                        : null,
                        ...
                        Expanded(
                          child: TabBarView(
                            controller: _tab,
                            children: [
                              _buildTableView(_allCompleted,       tabIndex: 0, showType: true),
                              _buildTableView(_solarCompleted,     tabIndex: 1, showType: false),
                              _buildTableView(_sprinklerCompleted, tabIndex: 2, showType: false),
                            ],
                          ),
                        ),
                      ],
    ...
    return RefreshIndicator(
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          final minW =
              constraints.maxWidth < 900 ? 940.0 : constraints.maxWidth;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
            color: _kGreen.withValues(alpha: 0.25), width: 1.2),
      ),
      child: Theme(
        ...
        child: ExpansionTile(
          ...
          title: Row(children: [
            Container(
              ...
              child: const AppSvgIcon(AppSvgAssets.calendarDays,
    ...
    return Column(
      ...
      children: [
        Row(mainAxisSize: MainAxisSize.min, children: [
          const AppSvgIcon(AppSvgAssets.circleCheckBig, size: 10, color: _kGreen),
          const SizedBox(width: 3),
        ...
        Text(DateFormat('hh:mm a').format(dt),
            style: TextStyle(
                fontSize: 10, color: _kGreen.withValues(alpha: 0.75))),
      ],
    );
  }
    ...
    return Center(
      child: Padding(
        ...
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            AppSvgIcon(AppSvgAssets.clipboardList,
